<template>
  ...
  <div>
    ...
    <DelModal    ref="delArticleModal" :delArticle="tempArticle"  @update-article="getArticles" ></DelModal>
...
import DelModal from "@/components/delarticle.vue";
